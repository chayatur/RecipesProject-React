...
import { Card, CardContent, CardMedia, Typography, List, ListItem, ListItemText, Box, CircularProgress, Divider, Stack, Chip } from "@mui/material";
...
const ShowRecipe = observer(() => {
  let recipe = RecipeStore.currRecipie;
      ...
      <Box display="flex" justifyContent="center" alignItems="center" mt={4}>
        <Card sx={{ width: 600, boxShadow: 4, borderRadius: 3 }}>
          <CardMedia
            component="img"
            height="300"
            image={RecipeStore.currImage[recipe.Img] || recipe.Img} 
            alt={recipe.Name}
          />
          <CardContent>
